...
| [Destaques](bumps.md)&nbsp;&nbsp;![](https://img.shields.io/static/v1?label=&message=New&color=green)     | Permite aplicação de destaques em anúncios e consulta de configurações de anúncios destacados | Disponível      |
